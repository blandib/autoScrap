 // Sample product data for scrapyard parts
    const products = [
...
testImage("image/car5.jpg");
        ...
        async function placeOrder(e) {
            ...
            try {
                // Send email using FormSubmit (EXACTLY like your original code)
...
This order was received through Ekene AutoScrap website.
                ...
                // Send email to store owner - USING YOUR EXACT EMAIL
...
Thank you for choosing Ekene AutoScrap!
        ...
        async function sendContactMessage(e) {
            ...
            try {
                // Send email using FormSubmit - USING YOUR EXACT EMAIL
                const formData = new FormData();
                formData.append('_template', 'basic');
